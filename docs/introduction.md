...
This page walks through the ideas behind Poet. If you want to jump straight to installing, head to [Getting Started](/getting-started).
...
Poet is the framework that makes it possible for skills to run themselves. Give it a project with schedulable skills:

```sh
poet start
```

Poet figures out which of your skills can be scheduled, runs the scheduler agent, spawns agents in isolated git worktrees, merges their work back, and loops.

You write the skills. Poet makes them run themselves.

## What to read next

- [Getting Started](/getting-started) — install Poet and run your first loop
