...
Not every task needs the same model. Formatting a file is a waste of Opus. Designing an architecture is a bad fit for a small, fast model. Poet's routing system lets you match models to tasks.

## Defaults

Set your default model in `.poet.toml`:
