...
This page describes the [brainmaxxing](https://github.com/poteto/brainmaxxing) skill pack, an optional addon that gives Poet agents persistent memory across sessions. Brainmaxxing is not part of Poet's core. The poet loop works without it.
