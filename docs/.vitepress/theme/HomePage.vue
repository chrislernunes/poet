  ...
  <div class="home">
    ...
    <header class="header">
      <div class="header-inner">
        <div class="header-left">
          <a :href="withBase('/')" class="brand">POET</a>
          <nav class="header-nav">
            <a :href="withBase('/getting-started')" class="nav-link">Docs</a>
            <a
              :href="withBase('/cookbook/minimal-poet-loop')"
              class="nav-link"
              >Cookbook</a
            >
          </nav>
    ...
    <main class="main">
      <div class="container">
        ...
        <!-- Hero -->
        <section class="hero">
          <h1 class="hero-line-2 hero-title">POET</h1>
          ...
          <p class="hero-sub hero-desc">
            Orchestrate agents using skills. Poet handles the rest.
          </p>
