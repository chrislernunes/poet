...
Install [brainmaxxing](https://github.com/poteto/brainmaxxing) to add this optional upgrade to Poet.
...
**Poet works without this**. The poet loop does not depend on it. This is entirely additive, and you can skip this if you prefer.
...
After installing, add `schedule:` fields to reflect and meditate so the poet loop runs them automatically. For example, tell your agent:
